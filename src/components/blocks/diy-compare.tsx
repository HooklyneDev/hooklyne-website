...
const NL_TABS: TabDef[] = [
  {
    ...
    steps: [
      ...
      { step: "3", label: "Belandt in My Leads met een aanleiding",
        detail: "Elke prospect komt binnen met een signaal: fundingronde, hire, leiderschapswissel, launch. Dubbel gescoord - een keer voor het bedrijf, een keer voor wat jij verkoopt. Alleen wat door beide komt, bereikt jou.",
  ...
  },
  {
    ...
    steps: [
      { step: "1", label: "Werk de agency in",
        detail: "Strategie-calls, klantprofiel-documenten, persona-workshops, messaging-reviews. Ze leren jouw business kennen. Dure weken kalendertijd voordat er een prospect is benaderd.",
