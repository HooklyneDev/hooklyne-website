...
const EN_TABS: TabDef[] = [
  {
    ...
    steps: [
      ...
      {
        step: "2", label: "Pick who to reach",
        ...
        time: "30 sec", callout: "We use 21 data providers. Four checks. One verdict.", good: true,
      },
      {
      ...
      },
      {
        ...
        time: "auto", callout: "Written for this prospect. Dutch or English.", good: true,
      },
      {
...
const NL_TABS: TabDef[] = [
  {
    ...
    steps: [
      ...
      { step: "2", label: "Kies wie je wilt bereiken",
        ...
        time: "30 sec", callout: "We gebruiken 21 databronnen. Vier checks. Één verdict.", good: true },
      ...
      { step: "4", label: "Volledige mail, in jouw schrijfstijl",
        ...
        time: "auto", callout: "Geschreven voor die prospect. NL of EN.", good: true },
