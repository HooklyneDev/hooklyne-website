  ...
  },
  {
    ...
    steps: [
      { step: "1", label: "De agency inwerken",
        detail: "Kennismakingsgesprekken, voorbeelddocumenten, heen-en-weermail over je klantprofiel. Ze leren je markt kennen. Weken gaan voorbij voordat er iemand is benaderd.",
