...
const NL_VARIANTS: Record<CTAVariant, CTACopy> = {
  home: {
    ...
    body: "Wij bouwen tien complete prospects voor jouw markt. Geverifieerde contacten, koopsignalen, een eerste mail in je toon. Geen creditcard. Wij vragen alleen 20 minuten feedback terug.",
  ...
  "how-it-works": {
    ...
    body: "Jij kiest tien bedrijven. Wij draaien er alle zes fases op. Jij beoordeelt mee, in real time. Wat eruit komt is van jou. Geen creditcard. Geen verplichting.",
    primaryLabel: "Start je gratis pilot",
  ...
  product: {
    ...
    body: "Klik door het portaal. Bekijk de prospect-kaarten. Lees de drafts. Allemaal op echte accounts uit jouw markt. Wij vragen 20 minuten feedback in ruil.",
    primaryLabel: "Start je gratis pilot",
  ...
  about: {
    ...
    body: "Hooklyne is gemaakt in Nederland. Voor Nederlands en Brits B2B-MKB. Probeer het eerst, beslis daarna. Tien complete pakketten kost je niks.",
    primaryLabel: "Start je gratis pilot",
    secondaryLabel: "Lees de FAQ",
    secondaryHref: "/nl/faq",
  },
  pricing: {
    ...
    body: "Tien complete prospects voor je een creditcard nodig hebt. Bekijk de output op jouw markt. Kies daarna welk abonnement bij je past.",
    primaryLabel: "Start je gratis pilot",
    secondaryLabel: "Zie hoe het werkt",
    secondaryHref: "/nl/hoe-het-werkt",
  },
  faq: {
    ...
    body: "Tien complete prospects op je eigen accounts. Gratis. De vragen die daarna overblijven, beantwoorden we in het feedbackgesprek na afloop.",
    primaryLabel: "Start je gratis pilot",
    secondaryLabel: "Bekijk prijzen",
    secondaryHref: "/nl/prijzen",
  },
