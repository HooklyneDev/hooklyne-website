...
const EN_VARIANTS: Record<CTAVariant, CTACopy> = {
  home: {
    ...
    body: "Ten fully built prospects. Verified contacts, real signals, messages in your voice. No card, no commitment.",
  ...
  product: {
    ...
    body: "See the portal, the prospect cards, and the drafts on real accounts from your market. No card needed.",
    primaryLabel: "Try for free",
  ...
  faq: {
    ...
    body: "Ten prospects, fully built, free. See the packages on your own accounts. Any question left over, ask us afterwards.",
    primaryLabel: "Try for free",
    secondaryLabel: "See pricing",
    secondaryHref: "/pricing",
  },
...
const NL_VARIANTS: Record<CTAVariant, CTACopy> = {
  home: {
    ...
    body: "Tien complete prospectpakketten. Geverifieerde contacten, echte signalen, berichten in jouw schrijfstijl. Zonder creditcard, geen verplichting.",
    primaryLabel: "Probeer gratis",
  ...
  product: {
    ...
    body: "Klik door het portaal, bekijk de prospectkaarten en lees de drafts op echte accounts uit jouw markt. Geen creditcard nodig.",
    primaryLabel: "Probeer gratis",
  ...
  pricing: {
    ...
    heading: "Eerst proberen, dan betalen.",
  ...
  faq: {
    ...
    body: "Tien complete prospectpakketten op je eigen accounts, helemaal gratis. Vragen die daarna nog overblijven, beantwoorden we daarna.",
    primaryLabel: "Probeer gratis",
    secondaryLabel: "Bekijk prijzen",
    secondaryHref: "/nl/prijzen",
  },
