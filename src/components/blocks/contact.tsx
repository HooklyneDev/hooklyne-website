...
const NL = {
  ...
  sub: "Boek een demo, start een gratis pilot of stel ons een vraag. De meeste antwoorden komen binnen vier uur en nooit later dan één werkdag.",
  ...
  successBody: "Je krijgt binnen één werkdag antwoord van een echt persoon, en in de meeste gevallen al binnen vier uur.",
