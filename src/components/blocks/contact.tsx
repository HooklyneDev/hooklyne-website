    ...
    <section className="pt-32 pb-20 lg:pt-40 lg:pb-28">
      <div className="container max-w-6xl">
        ...
        <div className="grid lg:grid-cols-5 gap-6">
          <div className="lg:col-span-3 rounded-2xl border border-[var(--border)] bg-[var(--card)] p-7" style={{ boxShadow: "var(--shadow-md)" }}>
        ...
        <div className="mt-12 rounded-2xl border border-[var(--border)] bg-[var(--card)] p-7 lg:p-8" style={{ boxShadow: "var(--shadow-xs)" }}>
